...
genpb:
	...
	./tools/protoc --proto_path=protos/ --plugin=protoc-gen-chat=./tools/protoc-gen-chat --chat_out=rpcext=true,rpccli="internal/api",rpcinter="pkg/inter/rpcinter":. protos/rpc/*
